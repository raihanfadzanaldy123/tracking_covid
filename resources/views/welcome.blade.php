  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative" data-aos="fade-up" data-aos-delay="100">
      ...
      <div class="row icon-boxes">
        <div class="col-md-6 col-lg-3 align-items-md-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box">
            <div class="icon"><i class="ri-stack-line"></i></div>
            <div class="col-lg-3 col-md-5 col-6 mb-5 mb-lg-0 align-items-md-stretch">
            @foreach($url1 as $data)
                <div class="count-box">
                <h4 class="title" data-toggle="counter-up"><a href="">{{ $data['positif'] }}</a></h4>
                <p>Positif</p>
                </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3 align-items-md-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="200">
          <div class="icon-box">
            <div class="icon"><i class="ri-stack-line"></i></div>
              <div class="col-lg-3 col-md-5 col-6 mb-5 mb-lg-0 align-items-md-stretch">
                <div class="count-box">
                <h4 class="title" data-toggle="counter-up"><a href="">{{ $data['sembuh'] }}</a></h4>
                <p>Sembuh</p>
                </div>
            </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3 align-items-md-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="400">
          <div class="icon-box">
            <div class="icon"><i class="ri-command-line"></i></div>
            <div class="col-lg-3 col-md-5 col-6 d-md-flex align-items-md-stretch">
            <div class="count-box">
            <h4 class="title" data-toggle="counter-up"><a href="">{{ $data['meninggal'] }}</a></h4>
              <p>Meninggal</p>
            </div>
          </div>
          </div>
        ...
        <div class="col-md-6 col-lg-3 align-items-md-stretch mb-5 mb-lg-0" data-aos="zoom-in" data-aos-delay="500">
          <div class="icon-box">
      ...
      <div class="container" data-aos="fade-up">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 video-box align-self-baseline" data-aos="fade-right" data-aos-delay="100">
            <img src="{{asset ('frontEnd/assets/img/about-video.jpg')}}" class="img-fluid" alt="">
